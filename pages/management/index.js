...
export default function Management() {
	...
	return (
		<div className="Management md:flex items-center justify-center min-h-screen p-2 md:px-10 md:py-5">
			<div className="user-card md:w-2/3 p-5 shadow-user rounded-[10px]">
				...
				<form className="flex flex-col md:flex-row flex-wrap">
					<div className="w-full md:w-1/2 md:pr-2">
						<div className="text-2xl font-bold my-3">Surname</div>
						<input
							className="w-full"
							type="text"
