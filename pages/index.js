...
export default function Home() {
	return (
		<div className="Home flex items-center mx-2">
			<Head>
			...
			<section className="w-full flex flex-col md:flex-row justify-center text-center">
				<div className="md:w-1/2 font-bold italic flex flex-col justify-center items-center">
					...
					<div className="h-16 flex w-11/12 lg:w-1/2 my-5">
						<Link href="/info">
							<a className="btn w-1/2 mr-2">SCOPRI DI PIÙ</a>
						</Link>
						<Link href="/signin">
